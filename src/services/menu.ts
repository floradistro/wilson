...
const DEFAULT_MENU: MenuConfig = {
  ...
  slash: [
    ...
    { id: '12', menu_type: 'slash', item_id: 'location', label: 'location', description: 'Switch location', action: 'command', value: '/location', sort_order: 25, is_active: true },
    { id: '13', menu_type: 'slash', item_id: 'refresh', label: 'refresh', description: 'Sync from server', action: 'command', value: '/refresh', sort_order: 30, is_active: true },
    { id: '14', menu_type: 'slash', item_id: 'context', label: 'context', description: 'Show context usage', action: 'command', value: '/context', sort_order: 40, is_active: true },
    { id: '15', menu_type: 'slash', item_id: 'tokens', label: 'tokens', description: 'Show token usage', action: 'command', value: '/tokens', sort_order: 45, is_active: true },
    { id: '16', menu_type: 'slash', item_id: 'status', label: 'status', description: 'View status', action: 'command', value: '/status', sort_order: 50, is_active: true },
    { id: '17', menu_type: 'slash', item_id: 'help', label: 'help', description: 'Show help', action: 'command', value: '/help', sort_order: 55, is_active: true },
    { id: '18', menu_type: 'slash', item_id: 'logout', label: 'logout', description: 'Sign out', action: 'command', value: '/logout', sort_order: 100, is_active: true },
  ],
};
